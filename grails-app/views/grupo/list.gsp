			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="authority" title="${message(code: 'grupo.authority.label', default: 'Authority')}" />
				...
				<g:each in="${grupoInstanceList}" status="i" var="grupoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${grupoInstance.id}">${fieldValue(bean: grupoInstance, field: "authority")}</g:link></td>
