	...
	<body>
		...
		<div id="list-setor" class="content scaffold-list" role="main">
			...
			<table>
				<thead>
					<tr>
						...
						<th><g:message code="setor.responsavel.label" default="Responsavel" /></th>
				...
				<g:each in="${setorInstanceList}" status="i" var="setorInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: setorInstance, field: "responsavel")}</td>
			...
			<div class="pagination">
				<g:paginate total="${setorInstanceTotal}" />
			</div>
		</div>
	</body>
</html>
