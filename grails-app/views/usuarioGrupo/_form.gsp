...
<div class="fieldcontain ${hasErrors(bean: usuarioGrupoInstance, field: 'grupo', 'error')} required">
	...
	<g:select id="grupo" name="grupo.id" from="${protocolo.Grupo.list()}" optionKey="id" required="" value="${usuarioGrupoInstance?.grupo?.id}" class="many-to-one"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: usuarioGrupoInstance, field: 'usuario', 'error')} required">
	...
	<g:select id="usuario" name="usuario.id" from="${protocolo.Usuario.list()}" optionKey="id" required="" value="${usuarioGrupoInstance?.usuario?.id}" class="many-to-one"/>
</div>
